<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}" onsubmit="loginfunction()">
            ...
            {{-- Login with Metamask Component --}}
            <div class="flex items-center justify-end mt-4">
                <a class="btn" href="javascript:connectMetamask('{{url('')}}')"
                    style="background-color: #bace14; color: #ffffff; padding: 8px; width: 100%; text-align: center; display: block; border-radius:4px;">
                    Login with Metamask
                </a>
            </div>
